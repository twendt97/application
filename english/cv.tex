...
\begin{metasection}{Contact}
        ...
        \icontext{Send}{12}{\href{mailto:business@thilo-wendt.de}{business@thilo-wendt.de}}{black}\\[6pt]
...
%\icontext{Circle}{12}{C}{black}
  ...
  \begin{tabular*}{0.9\linewidth}[c]{rl}
    ...
    \faTerminal \space Shell  & \textcolor{complcol}{\faCircle \space\space \faCircle \space\space
                                \faCircle \space\space \faCircleO \space\space \faCircleO} \\
  \end{tabular*}
...
\begin{metasection}{Tools}
  ...
  \faCode \space Xilinx Vivado \\
  \textcolor{complcol}{\faCircle \space\space \faCircle \space\space \faCircle
    \space\space \faCircleO \space\space \faCircleO}
...
\cvevent{Since 12/2020}{Master Project: Development of an FPGA based value
  acquisition system for power electronics}{Nuremberg Institut of
  Technology}{Parallel operation of ADCs with a Xilinx UltraScale+ SoC
  FPGA}{Digital signal processing of oversampled signals in hardware}

\cvevent{Since 10/2019}{Master Applied Research in Engineering
  Sciences}{Nuremberg Institut of Technology}{Hardware development for an SoC-FPGA
...
with Altium Designer}{Nuremberg Institut of Technology}{Development of an extension
...
\cvevent{10/2015 - 09/2019}{Graduated as B. Eng. Electrical Engineering and
  Information Technology (1.6)}{Nuremberg Institut of Technology}{Bachelor thesis:
...
\cvevent{10/2016 - 01/2018}{Tutorials for students}{Nuremberg Institut of
  Technology}{Subjects: Electrical measuring, microcomputers, fundamentals of
  electrical engineering}{Gained skills concerning presentation techniques and
  group leading}
...
\includegraphics[width=0.5cm]{../figures/tools.pdf} & Woodworking and
